...
- Now the main problem left is 3X3 box. So if we can somehow divide the whole sudoku into 9 parts cause each we have 9 of 3X3 boxes and if we can identify in which box does this element exists 
---
### 🧠 Insights
