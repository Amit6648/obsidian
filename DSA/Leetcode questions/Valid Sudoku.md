...
- For the first two directions which are  similar to [[Contains Duplicate]] we can just use [[Unordered Sets]] for each row and column and use c the speed to sets to
---
### 🧠 Insights
