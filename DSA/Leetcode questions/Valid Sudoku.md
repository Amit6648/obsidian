...
- Now the main problem left is 3X3 box. So if we can somehow divide the whole sudoku into 9 parts cause each we have 9 of 3X3 boxes and if we can identify in which box does this element exists we can check for the element.
- so the sudoku is of 9 x 9 if we want to know where does a element  of this 9 x 9 box will be we can do simple maths like if i want  
---
### 🧠 Insights
