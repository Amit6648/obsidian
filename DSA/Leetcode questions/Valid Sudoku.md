...
- here rather than having on only 3 we have a block of 3x3 meaning we have to check two directions so we can use row and column as key and divide them by 3 to find out in which block they are in but rather than using [[Unordered Hash maps]] we  will use 
---
### 🧠 Insights
