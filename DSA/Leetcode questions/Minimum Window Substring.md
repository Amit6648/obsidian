...
- SO basically problem is different from previous problems like [[Permutation in String]] rather than having a fixed target we have a bar that we need to reach we can also surpass this bar so we just needed something that can keep track if we are up or equal to this bar.
---
