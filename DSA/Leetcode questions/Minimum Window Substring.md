...
- To optimize this we can just create separate goals or needs if a character satisfy this need we increase the count and when all the needs are satisfied we will start to shrink the window to 
---
