...
- like we know that we need 2 a's and we have 3 a's in our window our window is valid and then we want to shrink the window to check if the window can be made smaller. So we a removed one a from window 
---
