...
- When we remove a element from window we will check if this character still satisfy that character frequency if not we will just decrease the count  and we will kn
---
