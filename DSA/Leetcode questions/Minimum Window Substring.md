...
- We have to shrink the window until it is not valid meaning we have to check every time if the window is valid then we shrink but to check manually if all the element in map2 are greater than or r
---
