...
- For example we cut a wooden log using cutter that can adapt to the size of the cut it made then when i need to know the original size of the log i can just tape log and cutter with each other and find
---
### 🧠 Insights
