...
- Well the main problem will be to how to know when minimum changed. we know that when a minimum number appeared and we decrease it from our current minimum we will get a negative number that will represent one part of our previous
---
### 🧠 Insights
