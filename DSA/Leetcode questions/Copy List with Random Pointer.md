...
- But we can improve space complexity by removing "hash map".  So by analysing the hash map method we know that we have to some connect original and copy elements so we can use the rando
