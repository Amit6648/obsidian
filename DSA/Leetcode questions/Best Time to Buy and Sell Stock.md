...
- We can use [[Sliding Window]] approach in which we can have two pointers left pointer will stay at the minimum element so far and right will move to find next minimum while calculati
