...
- We can look at it like this if we have two wall we can't tell how much water we can hold by just looking at one wall. So that means we have to look at know walls on 
---
### 🧠 Insights
