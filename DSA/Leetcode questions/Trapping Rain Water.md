...
- We can use the same approach as [[Container With Most Water]] just that we need to remember for each side what our maximum is and then we can compare those maximums and decide which side we should solve for using [[Two pointers]].
