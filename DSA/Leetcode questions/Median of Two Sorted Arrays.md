...
- So same here we will use binary search on smaller array and divide it and then according the elements we have on our left side we will decide how many to take from the left side of the larger 
