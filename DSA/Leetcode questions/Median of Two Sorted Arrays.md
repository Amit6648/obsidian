...
- So here is how we solve this problem so we divide the both arrays in two parts one will contain the smaller elements than the other part and to do that we will use binary search on smaller array it is like having two wooden planks one is shor
