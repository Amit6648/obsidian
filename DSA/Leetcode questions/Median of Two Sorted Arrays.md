...
- Now we have divided both arrays equally so to see if the partition that we have created is right we will compare them in cross meaning small left  with large right  and sleft with 
