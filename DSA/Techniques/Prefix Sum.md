...
For example if i wanted to find sum of certain range in a array like from 2th index to 5th index i need to do it one by one but with prefix i can just remove the certain e